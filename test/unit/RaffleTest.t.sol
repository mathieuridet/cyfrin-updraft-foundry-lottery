...
contract RaffleTest is Test, CodeConstants {
    ...
    function testDontAllowPlayersToEnterWhileRaffleIsCalculating() public raffleClosed {
    ...
    function testPerformUpkeepRevertsIfCheckUpkeepIsFalse() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Raffle.Raffle__UpkeepNotNeeded.selector, entranceFee, 1, raffle.getRaffleState())
        );
        raffle.performUpkeep("");
    }
    ...
    function testFulfillRandomWordsPicksAWinnerResetsAndSendsMoney(uint256 randomRequestId)
        public
        raffleEntered
        skipFork
    {
        ...
        assert(recentWinner.balance == winnerStartingBalance + (entranceFee * (additionalEntrants + 1)));
    }
